...
parser.add_argument('--dataset', default='30music', help='dataset name: diginetica/yoochoose/sample/30music/retailrocket/aotm')
...
if opt.dataset == 'diginetica':
    ...
    dataset = 'retailrocket.csv'
elif opt.dataset =='yoochoose':
    dataset = 'yoochoose-clicks.dat'
elif opt.dataset == 'aotm':
    dataset = 'aotm.csv'
...
if opt.dataset == 'yoochoose':
    ...
    splitdate = maxdate - 86400 * 7000 # retailrocket  
elif opt.dataset == 'aotm':
    splitdate = maxdate - 86400 * 30 # aotm
else:
    print("maxdate: ", maxdate)
    splitdate = maxdate - 86400 * 7 # sample, diginetica, 30music
...
#print("tr_seqs[:3], tr_dates[:3], tr_labs[:3]: ", tr_seqs[:3], tr_dates[:3], tr_labs[:3])
#print("te_seqs[:3], te_dates[:3], te_labs[:3]: ", te_seqs[:3], te_dates[:3], te_labs[:3])
all = 0
...
if opt.dataset == 'diginetica':
    ...
    pickle.dump(tra_seqs, open('retailrocket/all_train_seq.txt', 'wb'))
elif opt.dataset == 'aotm':
    if not os.path.exists('aotm'):
        os.makedirs('aotm')
    pickle.dump(tra, open('aotm/train.txt', 'wb'))
    pickle.dump(tes, open('aotm/test.txt', 'wb'))
    pickle.dump(tra_seqs, open('aotm/all_train_seq.txt', 'wb'))
