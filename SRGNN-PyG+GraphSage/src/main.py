...
parser.add_argument('--metodo', default='GGNN', help='nome metodo: GGNN/Mean/Max/LSTM')
parser.add_argument('--dataset', default='30music', help='dataset name: diginetica/yoochoose1_4/yoochoose1_64/30music/aotm/sample')
parser.add_argument('--batch_size', type=int, default=100, help='input batch size')
parser.add_argument('--hidden_size', type=int, default=20, help='hidden state size')
...
def main():
    ...
    model = GNNModel(hidden_size=opt.hidden_size, n_node=n_node, metodo=opt.metodo).to(device)
